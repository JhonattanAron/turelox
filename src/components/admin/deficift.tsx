...
export default function Deficift(props: Props) {
  return (
    <div className="p-4 bg-white shadow-2xl m-5 rounded-2xl w-36 ">
      <div className="flex items-center">
        <span className={`relative w-4 h-4 p-2 bg-blue-500 rounded-full`}>
          <svg
            width="20"
            fill="currentColor"
            height="20"
        ...
        <p className="ml-2 text-gray-700 text-md ">Deficit </p>
      </div>
